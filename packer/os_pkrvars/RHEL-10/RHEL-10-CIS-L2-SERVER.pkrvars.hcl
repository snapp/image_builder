...
# Center for Internet Security® (CIS) Level 2 Server
# https://www.cisecurity.org/cis-benchmarks
# https://resources.cisecurity.org/benchmarks

image_name    = "RHEL-10-CIS-L2-SERVER"
...
post_scripts = [
  {
    name = "Center for Internet Security® (CIS) Level 2 Server"
    description = "Apply CIS L2 Server SCAP remediation"
    content = <<-EOT
